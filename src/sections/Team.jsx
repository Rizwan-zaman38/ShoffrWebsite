            ...
            <div className='flex justify-center items-center text-center w-full text-white bg-black border border-[#D4C5A0]'>
                <div className='flex flex-col gap-5 justify-center items-center px-3 mt-20 max-sm:gap-2 max-sm:mt-10 max-w-3xl'>
                    ...
                    <div className='flex justify-center gap-2'>
                        <a href='#fleet' className='font-sans border  border-[#D4C5A0] py-2 px-5 hover:bg-slate-500 rounded-sm sm:text-base max-sm:py-1 max-sm:px-3 cursor-pointer'>Hire our ride</a>
                        <a href='#booking' className='font-sans py-2 px-5 hover:bg-slate-500 rounded-sm sm:text-base max-sm:py-1 max-sm:px-3 cursor-pointer'>Learn more <i class="fa-solid fa-angle-right"></i></a>
                    </div>
