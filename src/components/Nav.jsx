            ...
            <nav className='flex justify-between items-center py-1 px-16 '>
                ...
                <div className='hidden lg:flex justify-between items-center'>
                    ...
                    <div className='flex gap-4'>
                        <a href='#booking' className='text-[16px] font-Roboto border border-slate-300 py-2 px-4 rounded-sm hover:bg-slate-300 cursor-pointer transition ease-in-out duration-500 hover:scale-110'>Book Now</a>
                        <Link to="/contact" className='text-[16px] flex justify-center items-center gap-2 font-Roboto bg-black text-white py-2 px-4 rounded-[4px] hover:bg-slate-600 cursor-pointer transition ease-in-out duration-500 hover:scale-110'><Phone width={16} height={16} />Contact</Link>
                    </div>
                </div>
